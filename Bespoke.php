...
<body>
    ...
    <div>
        <form id="inquiry-holiday-enquiry-form">
          <h2>Holiday Enquiry Form</h2>
          ...
          <form action="https://formsubmit.co/salukasubasinghe60@gmail.com" method="POST">
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="inquiry-departure_date">Departure Date:</label>
                <input type="date" class="form-control" id="inquiry-departure_date" name="departure_date">
            </div>
            <div class="form-group">
                <label for="inquiry-arrival_date">Arrival Date:</label>
                <input type="date" class="form-control" id="inquiry-arrival_date" name="arrival_date">
            </div>
            <div class="form-group">
                <label for="inquiry-no_of_nights">No of nights:</label>
            ...
            <div class="form-group">
                <label for="inquiry-adults">No of Adults:</label>
                <input type="number" class="form-control" id="inquiry-adults" name="adults">
            </div>
            <div class="form-group">
                <label for="inquiry-children">No. of Children:</label>
                <input type="number" class="form-control" id="inquiry-children" name="children">
            </div>
            <div class="form-group">
                <label for="inquiry-hotel_type">Price guide & select your hotel types:</label>
                <input type="text" class="form-control" id="inquiry-hotel_type" name="hotel_type">
            </div>
            <div class="form-group">
                ...
                <br>
                <input type="checkbox" id="inquiry-spa" name="special_interests[]" value="spa">
                <label for="inquiry-spa">Spa's</label>
            </div>
            <div class="form-group">
                <label for="inquiry-requirements">Tell us how you want to spend your holiday:</label>
